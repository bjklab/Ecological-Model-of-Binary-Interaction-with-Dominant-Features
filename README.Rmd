...
The absence of paired minutes likely reflects prior knowledge regarding the efficacy of pairing. In our demonstration examples, we have not taken differences in prior probability of successful pairing into account, but the EMBIID model structure permits this prior knowledge to be incorporated.  
